...
//        let viewController = ViewController()
        ...
        func createTabBar() -> UITabBarController {
            ...
            tabBar.viewControllers = [createFollowersNC(), createFavoritesListNC()]
        
            return tabBar
        }
        
        func createFollowersNC() -> UINavigationController{
            let followersVC = SearchVC()
            followersVC.title = "Followers"
            followersVC.tabBarItem = UITabBarItem(tabBarSystemItem: .search, tag: 0)
            
            return UINavigationController(rootViewController: followersVC)
        }
